...
* Tailor the .gitlab-ci.yml file to your needs. The .gitlab-ci.yml file contains common jobs as a template that need
  to be customized. The file also contains a basic build job for clang and a unit test called add_one that runs
  as part of the generate-coverage-report job as an example unit test.
